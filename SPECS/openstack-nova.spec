...
Patch0002: 0002-Stash-CPU-policy-related-extra_spec-in-system_metada.patch
Patch0003: 0003-support-live-migrations-from-RHOS-5.patch
Patch0004: 0004-flavor-fix-unicode-error-with-flavor-name.patch
Patch0005: 0005-libvirt-support-live-migration-with-config-drives-on.patch
Patch0006: 0006-Clean-up-network_api.get_instance_nw_info.patch
Patch0007: 0007-Consolidate-code-to-get-the-correct-availability-zon.patch
Patch0008: 0008-Invalidate-AZ-cache-when-the-instance-AZ-information.patch
Patch0009: 0009-VMware-add-VirtualVmxnet3-to-the-supported-network-t.patch
Patch0010: 0010-console-fix-websocketproxy-error-1006.patch
Patch0011: 0011-rbd-use-rbd-snapshots-and-cloning-for-ephemeral-disk.patch
Patch0012: 0012-support-overriding-the-disk-driver-IO-policy.patch
Patch0013: 0013-Ironic-Extra-configdrive-metadata-from-Nodes.patch
Patch0014: 0014-fix-network-setup-on-evacuate.patch
Patch0015: 0015-network-fix-instance-cache-refresh-for-empty-list.patch
Patch0016: 0016-VMWare-Isolate-unit-tests-from-requests.patch
Patch0017: 0017-Support-ssh-keygen-of-OpenSSH-6.8.patch
Patch0018: 0018-libvirt-Enhance-iSCSI-volume-multipath-support.patch
Patch0019: 0019-Libvirt-Use-tpool-to-invoke-guestfs-api.patch
Patch0020: 0020-Make-the-Kilo-PciDevice-object-compatible-with-RHOS-.patch
Patch0021: 0021-Add-a-nova-manage-command-for-out-of-band-migration-.patch
Patch0022: 0022-Add-an-index-to-virtual_interfaces.uuid.patch
Patch0023: 0023-Ironic-Fix-delete-instance-when-spawning.patch
Patch0024: 0024-Skip-test_can_resize_need_fs_type_specified.patch
Patch0025: 0025-Fix-the-incorrect-PciDeviceList-version-number.patch
Patch0026: 0026-libvirt-mark-NUMA-huge-page-mappings-as-shared-acces.patch
Patch0027: 0027-Ironic-Use-ironicclient-native-retries-for-Conflict-.patch
Patch0028: 0028-Limit-parallel-live-migrations-in-progress.patch
Patch0029: 0029-Graceful-shutdown-WSGI-RPC-server.patch
Patch0030: 0030-libvirt-Kill-rsync-scp-processes-before-deleting-ins.patch

#neokylin add
Patch0100: nova-2015.1.0-neokylin-sound-spice.patch
Patch0101: 0101-nova-2015.1.0-neokylin-usb3-spicevmc.patch
Patch0102: 0102-nova-2015.1.0-neokylin-spice-passwd.patch
Patch0103: 0103-nova-2015.1.0-neokylin-usb2.patch
Patch0104: 0104-nova-2015.1.0-neokylin-usb_redirect_flag.patch
...
%changelog
* Thu Apr 07 2016 Wang Zhuo<zhuo.wang@cs2c.com.cn> - 2015.1.0-23
- usb redirect flag

* Fri Dec 25 2015 Wang Zhuo<zhuo.wang@cs2c.com.cn> - 2015.1.0-22
- use usb2

* Wed Dec 02 2015 Wang Zhuo <zhuo.wang@cs2c.com.cn> - 2015.1.0-21
- add spice passwd

* Fri Nov 13 2015 Wang Zhuo <zhuo.wang@cs2c.com.cn> 2015.1.0-20
- add usb3 and spicevmc channel

* Thu Oct 29 2015 Wang Zhuo <zhuo.wang@cs2c.com.cn> 2015.1.0-19
- Fix spice and sound problem

* Thu Aug 27 2015 Sahid Ferdjaoui <sferdjao@redhat.com> 2015.1.0-18
- Fix migration process does not stop when instance is deleted - rhbz#1241369

* Wed Aug 12 2015 Lon Hohberger <lon@redhat.com> 2015.1.0-17
- Use ironicclient native retries for Conflict in ClientWrapper
- Resolves: rhbz#1250088

* Fri Jul 17 2015 Matthew Booth <mbooth@redhat.com> 2015.1.0-16
- Fix failure to start when using pci_passthrough_whitelist - rhbz#1242502

* Wed Jul 15 2015 Matthew Booth <mbooth@redhat.com> 2015.1.0-15
- Fix performance issue related to large number of vifs - rhbz#1085989
- Fix hang deleting during create instance on Ironic - rhbz#1230163

* Tue Jun 30 2015 Matthew Booth <mbooth@redhat.com> 2015.1.0-14
- Fix blocking when using libguestfs - rhbz#1230485
- Add compatibility code to PCIRequest NovaObject for upgrades - rhbz#1203160

* Wed Jun 17 2015 Sahid Ferdjaoui <sferdjao@redhat.com> 2015.1.0-13
- iSCSI Support to attach volumes with path failure in multipath - rhbz#1228295

* Wed Jun 17 2015 Sahid Ferdjaoui <sferdjao@redhat.com> 2015.1.0-12
- Fix noVNC console access for an IPv6 setup - rhbz#1229655

* Tue Jun 16 2015 Victor Stinner <vstinner@redhat.com> 2015.1.0-11
- Fix network setup on evacuate - rhbz#1230237

* Thu Jun 11 2015 Pádraig Brady <pbrady@redhat.com> - 2015.1.0-10
- Fix issue with previous rebase

* Wed Jun 10 2015 Pádraig Brady <pbrady@redhat.com> - 2015.1.0-7
- Fix issue with previous rebase - rhbz#1228830
- Remove runtime dependency on pbr

* Fri Jun 05 2015 Sahid Ferdjaoui <sferdjao@redhat.com> - 2015.1.0-6
- Fix missing a dependency on conntrack-tools - rhbz#1226438

* Fri Jun 05 2015 Pádraig Brady <pbrady@redhat.com> - 2015.1.0-5
- Rebased RHOSP6 patches onto RHOSP7
- Fix startup race between libvirtd and nova-compute - rhbz#1222130

* Fri May 22 2015 Pádraig Brady <pbrady@redhat.com> - 2015.1.0-4
- Fix nova 'vendor' definition, impacting subscription management - rhbz#1224302
